...
pokemonToCatch = {Pokemon.CUBONE} --If you have a pokemonToRole, don't put them here too, unless you want to catch that pokemon with any ability.
--##########################################################################################
...
area = {20,30,23,31, 21,27,24,28, 21,28,27,28, 17,27,19,28, 31,29,33,30, 31,31,27,31, 29,30,33,30, 31,31,31,27, 25,30,31,30} --"Grass"
