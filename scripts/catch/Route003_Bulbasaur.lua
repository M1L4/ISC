...
pokemonToCatch = {Pokemon.BULBASAUR} --If you have a pokemonToRole, don't put them here too, unless you want to catch that pokemon with any ability.
--##########################################################################################
...
area = {84,35,84,38, 84,36,85,38, 81,38,85,38, 79,36,80,38, 81,34,83,34, 77,37,80,37, 31,34,31,31, 31,31,35,31, 39,27,40,29, 35,25,31,25, 29,30,32,32 } --"Grass"
