...
pokemonToCatch = {Pokemon.CLEFAIRY} --If you have a pokemonToRole, don't put them here too, unless you want to catch that pokemon with any ability.
--##########################################################################################
...
area = {37,61,40,60, 39,59,37,59, 38,61,38,58, 35,51,40,54, 44,46,41,45, 37,58,40,58, 37,60,40,60, 33,55,28,55, 27,55,31,56, 27,55,27,59} --"Grass"
