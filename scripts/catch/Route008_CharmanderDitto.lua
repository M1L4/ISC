...
pokemonToCatch = {Pokemon.CHARMANDER, Pokemon.DITTO} --Pokemon.ABRA, Pokemon.DITTO, Pokemon.KADABRA} --If you have a pokemonToRole, don't put them here too, unless you want to catch that pokemon with any ability.
--##########################################################################################
...
area = {38,13,41,13, 38,13,39,15, 38,11,42,11, 37,17,35,20, 35,17,38,18, 41,18,41,15, 36,12,40,12, 37,11,40,13, 42,13,41,15} --"Grass"
