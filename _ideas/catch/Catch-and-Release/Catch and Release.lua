...
--pf = require ";../;../Routing/ProShinePathfinder/Pathfinder/MoveToApp"
--package.path = package.path .. ';./function/?.lua;'

--pf = require "Routing\\ProShinePathfinder\\Pathfinder\\MoveToApp.lua"
--pf = require "Routing.ProShinePathfinder.Pathfinder.MoveToApp"
--print(pf)
...
pf = require("D:/workspace/ProCoding/Routing/ProShinePathfinder/Pathfinder/MoveToApp.lua")
print(pf)
...
function onStart()
	...
	rand = 0 -- The rectangle we're using in moveToRandRect()
	tmpRand = 0	-- Used in moveToRandRect()
	...
	rectTimer = os.time() -- For use in moveToRandRect()
	startMoney = getMoney()
