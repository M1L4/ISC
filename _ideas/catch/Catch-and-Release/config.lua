...
statusMove = "Sweet Scent", "Spore", "Hypnosis", "Thunderwave"
...
catchList = { "Pikachu", "Diglett", "Dugtrio", "Farfetch'd", "Cubone", "Marowak" }

-- List of Pokémon to catch that will not get released under any circumstances
-- Also will not use Role Play on these Pokémon
exceptionCatches = { "Bulbasaur", "Charmander", "Squirtle", "Larvitar", "Abra", "Pikachu" }
...
abilities = { "Magic Guard", "Immunity", "Static", "Arena Trap" }
